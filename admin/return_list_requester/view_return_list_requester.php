...
<div class="card card-outline card-teal">
            ...
            <div class="row">
                ...
                <div class="col-md-6">
                    <div class="form-group">
                        <label for="requester_id" class="control-label text-info">Requester</label>
    ...
    <div class="card-footer py-1 text-center">
        ...
        <a class="btn btn-primary" href="<?php echo base_url.'/admin?page=return_list_requester/manage_return_list_requester&id='.(isset($id) ? $id : '') ?>">Edit</a>
        <a class="btn btn-dark" href="<?php echo base_url.'/admin?page=return_list_requester' ?>">Back To List</a>
    </div>
</div>
