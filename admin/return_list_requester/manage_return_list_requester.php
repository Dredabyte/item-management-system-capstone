...
<div class="card card-outline card-teal">
    <div class="card-header">
        <h4 class="card-title"><?php echo isset($id) ? "Return Details - " . $return_code : 'Create New Return Record for Requester' ?></h4>
    </div>
    <div class="card-body">
                ...
                <div class="row">
                    ...
                    <div class="col-md-6">
                        <div class="form-group">
                            <label for="requester_id" class="control-label text-info">Requester Name</label>
    ...
    <div class="card-footer py-1 text-center">
        ...
        <a class="btn btn btn-dark" href="<?php echo base_url . '/admin?page=return_list_requester' ?>">Cancel</a>
    </div>
</div>
...
<script>
    ...
    $(function() {
        ...
        $('#return-form').submit(function(e) {
            ...
            start_loader();
            $.ajax({
                url: _base_url_ + "classes/Master.php?f=save_return_requester",
                ...
                success: function(resp) {
                    if (resp.status == 'success') {
                        location.replace(_base_url_ + "admin/?page=return_list_requester/view_return_list_requester&id=" + resp.id);
