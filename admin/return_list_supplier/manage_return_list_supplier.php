...
<div class="content-header">
  <div class="container-fluid">
    <div class="row mb-2">
      <div class="col-sm-6">
        <h1 class="m-0">Create | Edit Return Lists - Suppliers</h1>
      </div><!-- /.col -->
      <div class="col-sm-6">
        <ol class="breadcrumb float-sm-right">
          ...
          <li class="breadcrumb-item active">Create | Edit Return Lists</li>
        </ol>
      </div><!-- /.col -->
    </div><!-- /.row -->
  </div><!-- /.container-fluid -->
...
<div class="card card-outline card-orange">
    <div class="card-header">
        <h4 class="card-title"><?php echo isset($id) ? "Return Details - " . $return_code : 'Create New Return Record for Supplier' ?></h4>
    </div>
    <div class="card-body">
    ...
    <div class="card-footer py-1 text-center">
        <button class="btn btn btn-primary" type="submit" form="return-form">Save</button>
        <a class="btn btn btn-dark" href="<?php echo base_url . '/admin?page=return_list_supplier' ?>">Cancel</a>
    </div>
</div>
...
<script>
    ...
    $(function() {
        ...
        $('#return-form').submit(function(e) {
            ...
            start_loader();
            $.ajax({
                url: _base_url_ + "classes/Master.php?f=save_return_supplier",
                ...
                success: function(resp) {
                    if (resp.status == 'success') {
                        location.replace(_base_url_ + "admin/?page=return_list_supplier/view_return_list_supplier&id=" + resp.id);
