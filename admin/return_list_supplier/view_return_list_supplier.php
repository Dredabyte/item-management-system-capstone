...
<div class="card card-outline card-primary">
    ...
    <div class="card-footer py-1 text-center">
        ...
        <a class="btn btn-primary" href="<?php echo base_url.'/admin?page=return_list_supplier/manage_return_list_supplier&id='.(isset($id) ? $id : '') ?>">Edit</a>
        <a class="btn btn-dark" href="<?php echo base_url.'/admin?page=return_list_supplier' ?>">Back To List</a>
    </div>
</div>
