...
<div class="content-header">
  <div class="container-fluid">
    <div class="row mb-2">
      <div class="col-sm-6">
        <h1 class="m-0">Back Order Details</h1>
      </div><!-- /.col -->
      <div class="col-sm-6">
        <ol class="breadcrumb float-sm-right">
          <li class="breadcrumb-item"><a href="./">Dashboard</a></li>
          <li class="breadcrumb-item"><a href="<?php echo base_url.'admin?page=backorder_list' ?>">Back Order Lists</a></li>
          <li class="breadcrumb-item active">Back Order Details</li>
        </ol>
      </div><!-- /.col -->
    </div><!-- /.row -->
  </div><!-- /.container-fluid -->
...
<?php 
$qry = $conn->query("SELECT b.*,s.name as supplier,p.po_code FROM backorder_list b inner join supplier_list s on b.supplier_id = s.id inner join purchase_order_list p on b.po_id = p.id  where b.id = '{$_GET['id']}'");
if($qry->num_rows >0){
...
<div class="card card-outline card-teal">
    ...
    <div class="card-footer py-1 text-center">
        ...
        <a class="btn btn btn-dark" href="<?php echo base_url.'/admin?page=backorder_list' ?>">Back to List</a>
    </div>
</div>
</div>
...
<script>
    ...
    $(function(){
        $('#print').click(function(){
            ...
            p.find('tr.text-light').removeClass("text-light bg-lightblue")
            _el.append(_head)
