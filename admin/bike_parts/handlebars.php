...
<div class="content-header">
    <div class="container-fluid">
        <div class="row mb-2">
            <div class="col-sm-6">
                <h1 class="m-0">HANDLEBARS, AEROBARS and BAR ENDS</h1>
            </div><!-- /.col -->
            <div class="col-sm-6">
                <ol class="breadcrumb float-sm-right">
                    <li class="breadcrumb-item"><a href="<?php echo base_url ?>admin/?page=bike_parts">Bike Parts & Components</a></li>
                    <li class="breadcrumb-item active">Handlebars, Aerobars and Bar ends</li>
                </ol>
            </div><!-- /.col -->
        </div><!-- /.row -->
    </div><!-- /.container-fluid -->
                ...
                <div class="card card-outline card-gray">
                    ...
                    <div class="card-body table-responsive p-0">
                        ...
                        <table id="" class="table table-bordered">
                            ...
                            <tbody>
                                <?php
                                $selectedCategoryIds = [24, 25, 28]; // An array of category IDs
