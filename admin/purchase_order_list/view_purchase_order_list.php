...
<div class="card card-outline card-navy">
    ...
    <div class="card-footer py-1 text-center">
        ...
        <a class="btn btn btn-primary" href="<?php echo base_url.'/admin?page=purchase_order_list/manage_purchase_order_list&id='.(isset($id) ? $id : '') ?>">Edit</a>
        <a class="btn btn btn-dark" href="<?php echo base_url.'/admin?page=purchase_order_list' ?>">Back To List</a>
    </div>
</div>
