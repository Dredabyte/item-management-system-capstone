...
<div class="card card-outline card-yellow">
    ...
    <div class="card-footer py-1 text-center">
        <button class="btn btn-primary" type="submit" form="sale-form">Save</button>
        <a class="btn btn-dark" href="<?php echo base_url . '/admin?page=outgoing_stock' ?>">Cancel</a>
    </div>
</div>
...
<script>
    ...
    $(function() {
        ...
        $('#sale-form').submit(function(e) {
            ...
            start_loader();
            $.ajax({
                url: _base_url_ + "classes/Master.php?f=save_outgoing",
                ...
                success: function(resp) {
                    if (resp.status == 'success') {
                        location.replace(_base_url_ + "admin/?page=outgoing_stock/view_outgoing_stock&id=" + resp.id);
